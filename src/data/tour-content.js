...
export const chapters = [
  ...
  },
  {
    ...
    lines: [
      'Padel and cricket on weekends, a Mustang GT that',
      'treats fuel as a suggestion rather than a resource,',
      'coding projects that never see the light of day, and',
      "a watchlist of emerging markets that's always open",
...
export const billboardStories = {
  ...
  mustang: { meta: 'Garage district', title: 'Mustang GT', text: '5.0 litres of strictly discretionary horsepower, hydrated at 16L/100km. The one long position in the portfolio that is never, ever getting closed.' }
};
...
export const plazaBlurbs = [
  ...
  'After-hours plaza. Padel to the west, the cricket oval a few blocks northeast, and one very loud garage waiting down by the landing pad.',
